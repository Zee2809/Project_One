...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
    ...
    <div class="collapkse navbar-collapse" id="navbarSupportedContent">
  ...
  <td>
    <a href="Registration.php">
      <button style="margin-top:1%;margin-right:1%" ; type="button" class="btn btn-sm-first btn-outline-info">
        Add Employee</button>
    </a>
